...
const Navbar = () => {
  ...
  const [isDomainOpen, setIsDomainOpen] = useState(false); // State for controlling the Domain submenu
    ...
    <nav className="bg-gradient-to-r from-blue-100 to-blue-50 py-4 shadow-md fixed w-full z-10">
      <div className="container mx-auto flex justify-between items-center px-6">
        ...
        <div className="hidden md:flex space-x-8 items-center">
          ...
          <Link href="#documents" className="text-gray-800 hover:text-blue-600">Documents</Link>
      ...
      {isOpen && (
        <div className="md:hidden flex flex-col bg-white p-4 space-y-4">
          ...
          <Link href="#documents" className="text-gray-800" onClick={closeMenus}>Documents</Link>
